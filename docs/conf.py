...
from xlutils import __version__ 
from xlutils import __author__ 
from xlutils import __PYTHON_EXCEL_MODULE__
from xlutils import __PYTHON_EXCEL_TITLE__
...
copyright = '%s, %s' % (datetime.datetime.now().year, __author__)
